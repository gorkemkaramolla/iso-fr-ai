...
assets_dir = osp.expanduser('~/.insightface/models/antelopev2')
detector = SCRFD(os.path.join(assets_dir, 'scrfd_10g_bnkps.onnx'))
detector.prepare(0)
model_path = os.path.join(assets_dir, 'glintr100.onnx')
