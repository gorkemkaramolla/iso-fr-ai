...
#     if not os.path.exists(det_10g_model_path):
#         print(f"Model file not found: {det_10g_model_path}")
#         return

#     img_path = "../../face-images/fatih.jpeg"
#     img = cv2.imread(img_path)
#     if img is None:
#         print(f"Image file not found or could not be read: {img_path}")
#         return
...
#     # cv2.imshow("Image with White Border", img_with_border)
#     # cv2.waitKey(0)
...
#     # Detect faces
#     dets, kpss = model.detect(img_with_border, input_size=(640, 640), thresh=0.8, max_num=1)
#     print("Detections:", dets)
#     if kpss is not None:
#         print("Keypoints:", kpss)
