# ----------------------------- Real-time Anti-Spoofing Detection - SCRFD -2 -----------------------------
...
def process_frame(frame, model_test, image_cropper, model_dir):
    ...
    if label == 1:
        result_text = "R-Score: {:.2f}".format(value)
        color = (255, 0, 0)
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_dir",
        type=str,
        default="./iso-fr/services/models/anti_spoof_models",
    ...
    parser.add_argument(
        "--scrfd_model_path",
        type=str,
        default="./iso-fr/services/models/buffalo_l/det_10g.onnx",
        help="Path to the SCRFD model")
